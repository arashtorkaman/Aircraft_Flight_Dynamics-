...
The equations describe rigid-body translational dynamics, rotational dynamics, attitude kinematics, and Earth-frame position kinematics using body-axis velocities, body-axis angular rates, Euler angles, and Earth-frame position states.

> **Important limitation:** this model is intended for educational flight-dynamics, control-design, and simulation purposes. It is not a representation of the actual F-22 flight-control system, proprietary aerodynamic database, or classified aircraft model.
...
For implementation, the two-argument arctangent should be used:
...
For an aircraft with nonzero product of inertia $I_{xz}$, the rotational equations are:
...
Then the coupled roll-yaw angular-acceleration equation is:
...
Using a 3-2-1 Euler-angle sequence, the Euler angle kinematic equations are:
...
Euler angles have a singularity at:
...
The nonlinear dynamics function should follow this structure:
